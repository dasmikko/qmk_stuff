 ...
 */
	[_QWERTY] = LAYOUT(
        ...
        KC_LCTL  ,  KC_Z  ,  KC_X  ,  KC_C     ,  KC_V     ,  KC_B          ,  KC_RALT   ,  TFKEYS  ,                                 TGAMING  ,  KC_ESC  ,  KC_N   ,  KC_M     ,  KC_COMM  ,  KC_DOT  ,  KC_SLSH    ,  KC_RCTL, 
                                      KC_LGUI  ,  KC_LALT  ,  MO(_SYM_ALT)  ,  KC_SPC    ,  NAV     ,                                 SYM      ,  KC_LEFT ,  KC_UP  ,  KC_DOWN  ,  KC_RGHT
    ),
/*
 * Layer: Gaming
 *
 ...
 */
    [_GAMING] = LAYOUT(
        ...
        KC_NO   ,  KC_LCTL  , KC_A  ,  KC_S  ,  KC_D  ,  KC_F  ,  KC_G    ,  KC_H  ,                      KC_TRNS  ,  KC_K  , KC_L  ,  KC_LEFT  ,  KC_DOWN  ,  KC_RGHT  ,  KC_NO  ,  KC_ESC, 
 ...
 */
    ...
    [_SYM] = LAYOUT(
        ...
        KC_LSFT  ,  LSFT(KC_1)  ,  LSFT(KC_2)  ,  LSFT(KC_3)  ,  LSFT(KC_4)  ,  TD(TD_SLASH)  ,                                                                                           LSFT(KC_8)   ,  LSFT(KC_9)  ,  KC_EQL      ,  KC_RBRC     ,  KC_NUHS  ,  KC_TRNS  , 
